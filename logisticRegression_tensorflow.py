...
Reference: https://web.stanford.edu/class/cs20si/2017/lectures/notes_03.pdf
...
# Step 1: Read in data
# using TF Learn's built in function to load MNIST data to the folder dataset/mnist
